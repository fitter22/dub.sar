...
Welcome to the DUB.SAR tutorial series. This learning path introduces computational clay tablet programming from first principles, guiding newcomers from fundamental syntax to advanced bounded mathematical searches and persistent archives.
...
The tutorial covers the 12 core competencies of DUB.SAR across 10 progressive chapters:

| Chapter | Topics Covered | Key Concepts |
| :--- | :--- | :--- |
...
| **7. [Determinations & Selection](selection.md)** | • Determinations and atomic selection | Structured tuples, record indexing, sentinel `empty` (`nu`), atomic `retain` with criteria |
| **8. [Sequences & Structured Data](sequences.md)** | • Sequences and structured data | Ordered lists, zero-indexed access, sequence accumulation (`append`), tabular data structures |
| **9. [The Tablet Archive](archive.md)** | • The Tablet Archive | Embedded reference tablets, working scratchpads (`working`), permanent inscription (`inscribe`), SHA-256 provenance |
| **10. [Building a Complete Tablet](complete-example.md)** | • Complete mathematical tablet | Full astronomical leap-cycle search algorithm integrating all previous concepts |
